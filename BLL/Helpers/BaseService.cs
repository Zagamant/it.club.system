...
namespace System.BLL.Helpers
{
    public abstract class
        BaseService<TId, T, TAddModel, TUpdateModel, TModel> : IBaseService<TId, TAddModel, TUpdateModel, TModel>
        ...
        where T : BaseEntity, new()
    {
        ...
        public BaseService(DataContext context, IMapper mapper,
            ILogger<BaseService<TId, T, TAddModel, TUpdateModel, TModel>> logger)
        {
        ...
        public virtual async Task<IEnumerable<TModel>> GetAllAsync(string page = "",
            string pageSize = "", string sort = "", string filter = "")
        {
            ...
            {
                return await _table.Select(ent => _mapper.Map<TModel>(ent))
                    .ToListAsync();
            }
